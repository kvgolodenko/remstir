...
abstract class Captcha
{
	 ...
	 * @return object
	 */
	public static function instance($group = 'default', Response $response_object = NULL)
	{
		if ( ! isset(Captcha::$instance))
		{
			...
			Captcha::$instance = $captcha = new $class($group, $response_object);
	 ...
	 * @return void
	 */
	public function __construct($group = NULL, Response $response_object = NULL)
	{
		// Create a singleton instance once
		empty(Captcha::$instance) and Captcha::$instance = $this;

		if ($response_object instanceof Response)
		{
			if (! $this->response_object instanceof Response)
			{
	...
	public function image_render($html)
	{
        ...
        $this->response_object->headers(array(
