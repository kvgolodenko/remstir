...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/skeie/assets/tinymce_images'; // Relative to domain name
// 	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	$config['upload_path'] = '/Users/izaika/workspace/skeie/web/htdocs/assets/tinymce_images'; // Physical path. [Usually works fine like this]
