 ...
 *
 */
class Model_Startpage_Item_Image extends Model_Generic_Image {
	
	protected $_sorting = array('ord' => 'ASC');
	protected $_table_name = 'startpage_items';		
	
	public static $STORAGE_PATH = 'assets/startpage_item_images/';
