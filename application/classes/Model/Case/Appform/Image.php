...
class Model_Case_Appform_Image extends Model_Generic_Variables_Image {
protected $_reload_on_wakeup = FALSE;

	public static $STORAGE_PATH = 'assets/cases_page_appform_image/';
	...
	public static $title_field_name = 'cases_appform_img_title';
	public static $ext_field_name = 'cases_appform_img_ext';
	public static $uid_field_name = 'cases_appform_img_uid';
