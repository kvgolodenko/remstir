<?php
class Model_Contact_Image extends Model_Generic_Variables_Image {

	protected $_reload_on_wakeup = FALSE;

	public static $STORAGE_PATH = 'assets/contact_image/';
	...
	public static $title_field_name = 'contact_img_title';
	public static $ext_field_name = 'contact_img_ext';
	public static $uid_field_name = 'contact_img_uid';
