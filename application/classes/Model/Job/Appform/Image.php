<?php
class Model_Job_Appform_Image extends Model_Generic_Variables_Image {

	protected $_reload_on_wakeup = FALSE;

	public static $STORAGE_PATH = 'assets/job_app_image/';
	...
	public static $title_field_name = 'job_app_img_title';
	public static $ext_field_name = 'job_app_img_ext';
	public static $uid_field_name = 'job_app_img_uid';
